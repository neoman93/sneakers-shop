		...
		<div className="wrapper clear">
			...
			<div className="content p-40">
				...
				<div className="sneakers d-flex justify-between">
					<div className="card">
						<img className="card-img" src="/img/sneakers/1.jpg" alt="Sneakers" />
					...
					<div className="card">
						<img className="card-img" src="/img/sneakers/2.jpg" alt="Sneakers" />
						<h5 className="mb-40">Мужские Кроссовки Nike Air Max 270</h5>
						<div className="d-flex justify-between align-center">
							<div className="d-flex flex-column">
								<span>Цена:</span>
								<b>12 999 руб.</b>
					...
					<div className="card">
						<img className="card-img" src="/img/sneakers/3.jpg" alt="Sneakers" />
						<h5 className="mb-40">Мужские Кроссовки Nike Blazer Mid Suede</h5>
						<div className="d-flex justify-between align-center">
							<div className="d-flex flex-column">
								<span>Цена:</span>
					...
					<div className="card">
						<img className="card-img" src="/img/sneakers/4.jpg" alt="Sneakers" />
						<h5 className="mb-40">Кроссовки Puma X Aka Boku Future Rider</h5>
						<div className="d-flex justify-between align-center">
							<div className="d-flex flex-column">
								<span>Цена:</span>
								<b>8 999 руб.</b>
